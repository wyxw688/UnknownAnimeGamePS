...
public final class BattlePassAllDataNotifyOuterClass {
  ...
  public interface BattlePassAllDataNotifyOrBuilder extends
    ...
    /**
     * <code>bool HNDKICJJANM = 8;</code>
     * @return The hNDKICJJANM.
     */
    boolean getHNDKICJJANM();

    /**
     * <code>bool HOLKBIKHOBA = 9;</code>
     * @return The hOLKBIKHOBA.
     */
    boolean getHOLKBIKHOBA();
    ...
    /**
     * <code>uint32 ALPFBBEJIMO = 13;</code>
     * @return The aLPFBBEJIMO.
     */
    int getALPFBBEJIMO();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int HNDKICJJANM_FIELD_NUMBER = 8;
    ...
    public static final int HOLKBIKHOBA_FIELD_NUMBER = 9;
    private boolean hOLKBIKHOBA_;
    /**
     * <code>bool HOLKBIKHOBA = 9;</code>
     * @return The hOLKBIKHOBA.
     */
    @java.lang.Override
    public boolean getHOLKBIKHOBA() {
      return hOLKBIKHOBA_;
    }
    ...
    public static final int ALPFBBEJIMO_FIELD_NUMBER = 13;
    private int aLPFBBEJIMO_;
    /**
     * <code>uint32 ALPFBBEJIMO = 13;</code>
     * @return The aLPFBBEJIMO.
     */
    @java.lang.Override
    public int getALPFBBEJIMO() {
      return aLPFBBEJIMO_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (hNDKICJJANM_ != false) {
        output.writeBool(8, hNDKICJJANM_);
      }
      if (hOLKBIKHOBA_ != false) {
        output.writeBool(9, hOLKBIKHOBA_);
      }
      for (int i = 0; i < missionList_.size(); i++) {
        output.writeMessage(12, missionList_.get(i));
      }
      if (aLPFBBEJIMO_ != 0) {
        output.writeUInt32(13, aLPFBBEJIMO_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (hNDKICJJANM_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(8, hNDKICJJANM_);
      }
      if (hOLKBIKHOBA_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(9, hOLKBIKHOBA_);
      }
      for (int i = 0; i < missionList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (aLPFBBEJIMO_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(13, aLPFBBEJIMO_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getHOLKBIKHOBA()
          != other.getHOLKBIKHOBA()) return false;
      if (!getMissionListList()
          .equals(other.getMissionListList())) return false;
      if (getALPFBBEJIMO()
          != other.getALPFBBEJIMO()) return false;
    ...
    public int hashCode() {
      ...
      hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
          getHNDKICJJANM());
      hash = (37 * hash) + HOLKBIKHOBA_FIELD_NUMBER;
      hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
          getHOLKBIKHOBA());
      ...
      hash = (37 * hash) + ALPFBBEJIMO_FIELD_NUMBER;
      hash = (53 * hash) + getALPFBBEJIMO();
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.BattlePassAllDataNotifyOuterClass.BattlePassAllDataNotify buildPartial() {
        ...
        result.hOLKBIKHOBA_ = hOLKBIKHOBA_;
        if (missionListBuilder_ == null) {
        ...
        result.aLPFBBEJIMO_ = aLPFBBEJIMO_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.BattlePassAllDataNotifyOuterClass.BattlePassAllDataNotify other) {
        ...
        if (other.getHOLKBIKHOBA() != false) {
          setHOLKBIKHOBA(other.getHOLKBIKHOBA());
        }
        if (missionListBuilder_ == null) {
        ...
        if (other.getALPFBBEJIMO() != 0) {
          setALPFBBEJIMO(other.getALPFBBEJIMO());
        }
      ...
      /**
       * <code>bool HOLKBIKHOBA = 9;</code>
       * @param value The hOLKBIKHOBA to set.
       * @return This builder for chaining.
       */
      public Builder setHOLKBIKHOBA(boolean value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearHOLKBIKHOBA() {
      ...
      /**
       * <code>uint32 ALPFBBEJIMO = 13;</code>
       * @param value The aLPFBBEJIMO to set.
       * @return This builder for chaining.
       */
      public Builder setALPFBBEJIMO(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearALPFBBEJIMO() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ur_schedule\030\001 \001(\010\022)\n\014cur_schedule\030\003 \001(\0132" +
      "\023.BattlePassSchedule\022\023\n\013HNDKICJJANM\030\010 \001(" +
      "\010\022\023\n\013HOLKBIKHOBA\030\t \001(\010\022(\n\014mission_list\030\014" +
      " \003(\0132\022.BattlePassMission\022\023\n\013ALPFBBEJIMO\030" +
    ...
    internal_static_BattlePassAllDataNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_BattlePassAllDataNotify_descriptor,
        new java.lang.String[] { "HaveCurSchedule", "CurSchedule", "HNDKICJJANM", "HOLKBIKHOBA", "MissionList", "ALPFBBEJIMO", });
    emu.grasscutter.net.proto.BattlePassScheduleOuterClass.getDescriptor();
    emu.grasscutter.net.proto.BattlePassMissionOuterClass.getDescriptor();
  }
